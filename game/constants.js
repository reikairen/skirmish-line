...
const COMBINATION_NAMES = {
  ...
  [COMBINATION_TYPES.SUM]: 'Sum',
  [COMBINATION_TYPES.THREE_OF_A_KIND]: 'Three of a Kind',
  [COMBINATION_TYPES.COLOR]: 'Color',
  [COMBINATION_TYPES.RUN]: 'Run',
  [COMBINATION_TYPES.COLOR_RUN]: 'Color Run',
};
